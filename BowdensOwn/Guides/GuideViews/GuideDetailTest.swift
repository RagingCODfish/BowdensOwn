...
//    let guide = Guide(name: "Your new car detailing guide.", caption: "So you’ve just bought a new car and you want to look after it using the Bowden’s Own range of products. This article will take an in-depth look at all aspects of cleaning and maintaining your new car.", displayImage: "newcarguide", paragraph:
//                        [GuideStep(title: "Clean your wheels first",
//                                   paragraph: ["Always do any car washing in the shade, with the paint cool to the touch for best results. Not doing this can cause the water and the wash suds to evaporate faster than you'd like, possibly leading to water spots on the glass and paint!",
...
//                                               "Now attach the Cannon to the pressure washer, turn on the water, then power it up.", "For the thickest foam possible, turn the Cannon’s top blue air adjustment knob clockwise towards the “-” symbol. If you desire less foam or wish to use less foam solution, turn it the opposite way towards the “+” symbol.",
