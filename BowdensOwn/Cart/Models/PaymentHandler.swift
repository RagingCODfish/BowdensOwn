...
class PaymentHandler: NSObject {
    ...
    func shippingMethodCalculator() -> [PKShippingMethod] {
        ...
        if let shippingEnd = shippingEnd, let shippingStart = shippingStart {
            ...
            let shippingDelivery = PKShippingMethod(label: "Delivery", amount: NSDecimalNumber(string: "11.99"))
    ...
    func startPayment(orderItems: [OrderItem], total: Double, completion: @escaping PaymentCompletionHandler) {
        completionHandler = completion
        
        paymentSummaryItems = []
        
        orderItems.forEach { product in
        ...
        paymentRequest.merchantIdentifier = "merchant.com.zacharyuptin.BowdensOwn"
